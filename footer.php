 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              Vijaykumar Guggari<br>
		              Bengaluru, Karnataka<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+919740522534"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="https://www.linkedin.com/in/vijay-guggari/" target="_blank"> 
  <i class="fa fa-linkedin"></i> LinkedIn
</a>

                    <a role="button" class="btn btn-success" href="mailto:guggariv022gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
